...
public class ImageComparisonHelperImplementation {
    ...
    public void compare(String fileName) {
        ...
        try {
            ...
            File baselineFile =
                    new File(".gauge/screenshots/visual/baseline/" + fileName + ".png");

            File actualFile =
                    new File(".gauge/screenshots/visual/actual/" + fileName + ".png");
