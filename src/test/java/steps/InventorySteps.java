...
public class InventorySteps {
    ...
    public void verifyProductsPage() {
        inventoryStepsImplementation.verifyProductsPage();
    }

    @Step("User clicks menu button")
    public void clickMenuButton() {
        inventoryStepsImplementation.clickMenuButton();
    }

    @Step("User clicks logout button")
    public void clickLogoutButton() {
        inventoryStepsImplementation.clickLogoutButton();
    }

    @Step("User should see login page")
    public void verifyLoginPage() {
        inventoryStepsImplementation.verifyLoginPage();
    }

    @Step("User clicks <productName> product")
    public void clickProduct(String productName) {
        inventoryStepsImplementation.clickProduct(productName);
    }

    @Step("User should see <productName> product detail page")
    public void verifyProductDetailPage(String productName) {
        inventoryStepsImplementation.verifyProductDetailPage(productName);
    }

    @Step("User selects <filterOption> from sort dropdown")
    public void selectFilter(String filterOption) {
        inventoryStepsImplementation.selectFilterOption(filterOption);
    }
}
